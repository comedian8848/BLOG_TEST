...
<img src="../../../.vuepress/public/img/截图_2022-10-11_11-09-04.png">

栗子二：字段直接编码方式设计微指令格式

<img src="../../../.vuepress/public/img/截图_2022-10-11_11-17-34.png">
...
- 后一个写指令执行太快，覆盖了前一个写操作
- 为什么会出现后一个写快于前一个写？指令执行具有异步性，无法预判

注意：

- 当按序发生按序执行时，只会发生 WAR 错误，WAW 不回发生
- 相邻的定义并不是紧挨着，而是小于等于 n-2，n 为流水线段数
