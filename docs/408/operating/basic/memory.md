...
<img src="../../../.vuepress/public/img/QQ截图20221031212703.png">

增加快表，先查询快表 TLB，若无再查询页表

<img src="../../../.vuepress/public/img/QQ截图20221031213145.png">
...
二级页表：适用于 32 位计算机 —— 逻辑地址空间`2^32B`，若一个内存块大小为`4KB(2^12)`，若采用以及页表，将会有`2^20`个页面
